    ...
    <div class="min-vh-100 d-flex align-items-center justify-content-center">
        <div class="col-md-8 col-lg-5 col-xxl-4">
            <div class="card p-4">
                <div class="card-body">
                    ...
                    <div class="text-center mb-4">
                        <iconify-icon icon="mdi:book-open-page-variant" width="48" height="48"
                            class="iconify text-success"></iconify-icon>
            ...
            <div class="text-center mt-3 text-muted">
                <small>&copy; {{ date('Y') }} GoTugas</small>
            </div>
        </div>
    </div>
        ...
        tsParticles.load("particles-bg", {
            ...
            particles: {
                ...
                shape: {
                    type: "image",
                    image: [{
                            src: "https://cdn-icons-png.flaticon.com/512/590/590685.png", // daun hijau
                            width: 32,
                            height: 32
                        },
                        {
                            src: "https://cdn-icons-png.flaticon.com/512/415/415733.png", // apel merah
                            width: 32,
                            height: 32
                        }
                    ]
