    ...
    <div class="card border-0 shadow rounded-4">
        <div class="card-body p-4">
            ...
            <h3 class="fw-bold text-primary mb-2">
                <i class="bi bi-journal-text me-1"></i>{{ $tugas->judul }}
            </h3>
            ...
            @elseif ($pengumpulan)
                <div class="alert alert-info rounded-3 mt-4">
                    <h6 class="mb-2 fw-bold">
                        <i class="bi bi-info-circle me-1"></i>Status Pengumpulan
                    </h6>

                    @if ($pengumpulan->status === 'dikirim')
                        <p class="mb-1">Kamu sudah mengumpulkan tugas.</p>
                        <p class="fst-italic text-muted">Menunggu penilaian dari guru.</p>
            ...
            @else
                ...
                <h5 class="fw-bold mb-3">
                    <i class="bi bi-upload me-1"></i> Form Pengumpulan Tugas
                </h5>
